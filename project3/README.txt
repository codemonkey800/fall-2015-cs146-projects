...
but BSTs somehow outperform hashtables. So in order of speed: BSTs, hashtables, AVL trees. 
...
Given the much larger difference, it's reasonable to assume that Bacon did write Shakespare's plays; however, our conclusion should be taken with a grain of salt since 5.799e-4 is small, but not terribly small.
...
may have been too small. However, considering that the difference between run times are small, we don't have
...
In general, it seemd that BSTs performed the best, hash tables second, and AVL trees last.
...
of hashtable was bad. Or perhaps the rehashing took a toll on the running time of hashtables. But overall,
...
rehashing is done at a minimum (or not at all), and thus rehashing doesn't have to occur. Rehashing
...
Overall, both Phyllis and I enjoyed this project. Phyllis enjoyed writing the Correlator class and tester class
